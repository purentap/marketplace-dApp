...
class App extends Component {
  ...
  async componentWillMount(){ //runs anytime this component gets created
  ...
  async loadBlockchainData(){
    ...
    const networkId = await web3.eth.net.getId() //GETS 5777. dyanmic way
    ...
    if(networkData){
      ...
      const marketplace =  web3.eth.Contract(abi, address)  //create the smart contract
